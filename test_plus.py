...
parser.add_argument('--input_dir', default='./Datasets/MSRB', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/MSRB-dewater-nocharloss', type=str, help='Directory for results')
parser.add_argument('--weights', default='./checkpoint/De-water-msrb/models/DGUNet/model_best.pth', type=str, help='Path to weights')
...
datasets = ['test','Rain100L', 'Rain100H', 'Test100', 'Test1200', 'Test2800']
# datasets = ['Rain100L']
